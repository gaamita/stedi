...
machine_learning_curated_node1722309675920 = glueContext.write_dynamic_frame.from_catalog(frame=SQLQuery_node1722309415652, database="stedi", table_name="machine_learning_curated", additional_options={"enableUpdateCatalog": True, "updateBehavior": "UPDATE_IN_DATABASE"}, transformation_ctx="machine_learning_curated_node1722309675920")
