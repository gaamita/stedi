...
step_trainer_trusted_node1722308453235 = glueContext.write_dynamic_frame.from_catalog(frame=SQLQuery_node1722307480866, database="stedi", table_name="step_trainer_trusted", transformation_ctx="step_trainer_trusted_node1722308453235")
